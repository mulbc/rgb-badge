...
The rear battery rectangle is the nominal **protected GlobTek BL0750F5030481S1PCTC 700 mAh coupon-only candidate** from the [pack screen](../docs/sourcing/pack-screen-2026-09-25.md). It is **not an approved final battery**: the full-badge reference runtime model is about 4.9 h and the estimated maximum-white draw exceeds its documented continuous-discharge rating. Its pouch footprint does not include its protection board, cable/connector, wrap variation or swelling clearance. An actual final pack may have very different dimensions.
