...
Date: 2026-09-05
Project phase: requirements and KiCad workflow complete; matrix, driver and row-library native reviews passed; row/controller/power capture and layout remain
