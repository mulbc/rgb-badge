...
Date: 2026-09-05
Project phase: matrix, driver and row-library native reviews passed; complete row-stage source capture awaits native review; controller/power capture and layout remain
