...
- Owner-reported KiCad 10.0.6 export and blank-sheet ERC passed at `27c01b4fb3ddb3a863dc25fdb233b57a9f043403`, with a clean working tree. The uploaded six SVGs were inspected against both controlled drawings: symbol pin maps, copper pad sizes/centres and fabrication-label quadrants matched. Symbol readability passed; raw fabrication body outlines still crossed pad numbers.
- A separate derived numbered view copies the original KiCad glyph paths above a white halo. Both corrected drawings were rendered and visually inspected using the actual uploaded exports; all four numbers are readable and their original geometry groups are preserved. No symbol or footprint source changed in this final cleanup. The [review record](../../../../docs/development/led-library-review-27c01b4.md) contains source hashes and the two inspected examples.
- Local wrapper tests use a stub CLI and do not replace actual KiCad evidence. The updated wrapper was tested locally; the KiCad evidence above is the owner's `27c01b4` run. See the [macOS review instructions](../../../../docs/development/kicad-macos.md).
