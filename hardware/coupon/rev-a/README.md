...
Status: matrix and driver milestones reviewed and merged; exact row-selection libraries authored and locally audited; native row-library rendering plus independent Gate A verification pending; not safe to fabricate
