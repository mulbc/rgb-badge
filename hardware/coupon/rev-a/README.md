...
Next: [charger actuator screening](charger-actuator-screening.md). ADG4612BCPZ-REEL7 is an investigated candidate, not a selected or captured part; its supplied PDF has been reviewed and its [candidate library](charger-actuator-library-audit.md) is ready for native rendering. Current libraries contain 46 symbols / 27 footprints. The lands are project-derived and require assembler qualification.
