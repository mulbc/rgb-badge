...
- Native review and capture of exact `BQ24074RGTR`/`BQ24392RSER`/`TS3USB31ERSER` libraries, VBUS-powered priority logic and their final `ISET`/`ILIM`/termination/timer/NTC networks.
